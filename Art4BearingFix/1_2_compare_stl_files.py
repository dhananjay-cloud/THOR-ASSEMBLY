...
BUILD123D_STL = os.path.join(BASE_DIR, "1_Art4BearingFix_build123d_G_1_9.stl")
FUSION_STL    = os.path.join(BASE_DIR, "1_Art4BearingFix_original.stl") # <-- Updated filename!
REPORT_TXT    = os.path.join(BASE_DIR, "1_Art4BearingFix_build123d_vs_original_G_1_9.txt")
