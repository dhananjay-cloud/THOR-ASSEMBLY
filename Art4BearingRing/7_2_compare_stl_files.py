...
BUILD123D_STL = os.path.join(BASE_DIR, "7_Art4BearingRing_G_1_14.stl")
FUSION_STL    = os.path.join(BASE_DIR, "7_Art4BearingRing_original.stl") # <-- Updated filename!
REPORT_TXT    = os.path.join(BASE_DIR, "7_Art4BearingRing_original_build123d_vs_original_G_1_14.txt")
