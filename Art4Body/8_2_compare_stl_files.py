...
BUILD123D_STL = os.path.join(BASE_DIR, "8_Art4Body_G_1_42.stl")
FUSION_STL    = os.path.join(BASE_DIR, "8_Art4Body_original.stl") # <-- Updated filename!
REPORT_TXT    = os.path.join(BASE_DIR, "8_Art4Body_original_build123d_vs_original_G_1_42.txt")
