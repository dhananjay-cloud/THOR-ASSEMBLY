...
BUILD123D_STL = os.path.join(BASE_DIR, "3_Art4BodyFan_G_1_7.stl")
FUSION_STL    = os.path.join(BASE_DIR, "3_Art4BodyFan_original.stl") # <-- Updated filename!
REPORT_TXT    = os.path.join(BASE_DIR, "3_Art4BodyFan_original_build123d_vs_original_G_1_7.txt")
