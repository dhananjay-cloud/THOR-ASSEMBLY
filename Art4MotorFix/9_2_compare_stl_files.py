...
BUILD123D_STL = os.path.join(BASE_DIR, "9_Art4MotorFix_G_1_7.stl")
FUSION_STL    = os.path.join(BASE_DIR, "9_Art4MotorFix_original.stl") # <-- Updated filename!
REPORT_TXT    = os.path.join(BASE_DIR, "9_Art4MotorFix_original_build123d_vs_original_G_1_7.txt")
