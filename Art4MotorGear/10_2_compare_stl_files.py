...
BUILD123D_STL = os.path.join(BASE_DIR, "10_Art4MotorGear_G_1_15.stl")
FUSION_STL    = os.path.join(BASE_DIR, "10_Art4MotorGear_original.stl") # <-- Updated filename!
REPORT_TXT    = os.path.join(BASE_DIR, "10_Art4MotorGear_original_build123d_vs_original_G_1_15.txt")
