...
BUILD123D_STL = os.path.join(BASE_DIR, "4_Art4Optodisk_G_1_13.stl")
FUSION_STL    = os.path.join(BASE_DIR, "4_Art4Optodisk_original.stl") # <-- Updated filename!
REPORT_TXT    = os.path.join(BASE_DIR, "4_Art4Optodisk_original_build123d_vs_original_G_1_13.txt")
