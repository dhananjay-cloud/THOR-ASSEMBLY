...
BUILD123D_STL = os.path.join(BASE_DIR, "5_Art4TransmissionColumn_G_1_16.stl")
FUSION_STL    = os.path.join(BASE_DIR, "5_Art4TransmissionColumn_original.stl") # <-- Updated filename!
REPORT_TXT    = os.path.join(BASE_DIR, "5_Art4TransmissionColumn_original_build123d_vs_original_G_1_16.txt")
