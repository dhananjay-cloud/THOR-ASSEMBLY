...
BUILD123D_STL = os.path.join(BASE_DIR, "2_Art4BodyBot_G_1_18.stl")
FUSION_STL    = os.path.join(BASE_DIR, "2_Art4BodyBot_original.stl") # <-- Updated filename!
REPORT_TXT    = os.path.join(BASE_DIR, "2_Art4BodyBot_original_build123d_vs_original_G_1_18.txt")
